...
const iconComponents: Record<IconType, { component: () => React.JSX.Element; color: string }> = {
  ...
  mysql: {
    component: () => (
      <svg viewBox="0 0 24 24" fill="none" className="w-full h-full">
        <path
          d="M7 16c1.4-2.6 3.7-3.6 6.2-3.5 1.2 0 2.3-.3 3-1.1.8-.8 1.2-1.8 1.2-3.4 1.1 1.5 1.6 3 1.6 4.6 0 3.6-2.6 6.4-6.5 6.4-2.2 0-4.3-1-5.5-3Z"
          fill="#00758F"
        />
        <path
          d="M6.3 12.2c.9-2.9 3.1-5.1 6.2-6.1 1.7-.6 3.2-.6 4.8-.2-1.1.3-2 .8-2.6 1.6-.7.9-.8 1.8-.7 2.9-1.6-.3-3.1-.2-4.7.3-1.3.5-2.3 1-3 1.5Z"
          fill="#F29111"
        />
        <circle cx="9" cy="9" r="1.2" fill="#F29111" />
      </svg>
    ),
    color: '#00758F'
  },
  mongodb: {
    component: () => (
      <svg viewBox="0 0 24 24" fill="none" className="w-full h-full">
        <path
          d="M12 2c2 2.1 3.3 4.7 3.3 8.1 0 5-2.2 8.5-3.3 9.9-1.1-1.4-3.3-4.9-3.3-9.9C8.7 6.7 10 4.1 12 2Z"
          fill="#10AA50"
        />
        <path
          d="M12 5.1c.8 1.3 1.3 3 1.3 5.1 0 3.3-.9 5.8-1.3 6.8-.4-1-1.3-3.5-1.3-6.8 0-2.1.5-3.8 1.3-5.1Z"
          fill="#B8C4C2"
        />
      </svg>
    ),
  ...
  return (
    ...
    >
      ...
      >
        ...
        {isHovered && (
          <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 rounded bg-gray-900/95 px-2 py-1 text-xs whitespace-nowrap text-white backdrop-blur-sm pointer-events-none">
            {label}
          </div>
        )}
      </div>
...
export default function OrbitingSkills() {
  ...
  return (
    <main className="relative flex w-full items-center justify-center overflow-hidden">
      ...
      <div
        className="relative flex h-[calc(100vw-40px)] w-[calc(100vw-40px)] max-h-[460px] max-w-[460px] items-center justify-center md:h-[450px] md:w-[450px]"
